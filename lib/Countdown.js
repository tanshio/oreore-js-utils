...
var Countdown = /** @class */ (function () {
    ...
    Countdown.prototype.getOriginMillisecond = function () {
        return this.endDate - this.startDate;
    };
    Countdown.prototype.getSecond = function () {
        return Math.floor((this.getOriginMillisecond() % this.DAY) / 1000) % 60 % 60;
    };
    Countdown.prototype.getMinute = function () {
        return Math.floor((this.getOriginMillisecond() % this.DAY) / (60 * 1000)) % 60;
    };
    Countdown.prototype.getHour = function () {
        return Math.floor((this.getOriginMillisecond() % this.DAY) / (60 * 60 * 1000));
    };
    Countdown.prototype.getDay = function () {
        return Math.floor(this.getOriginMillisecond() / this.DAY);
    };
    Countdown.prototype.getWeek = function () {
        return Math.floor(this.getDay() % 7);
    };
    Countdown.prototype.getOriginMonth = function () {
        var month = difference_in_months(new Date(this.endDate), new Date(this.startDate));
        return month;
    };
    Countdown.prototype.getMonth = function () {
        return this.getOriginMonth() % 12;
    };
    Countdown.prototype.getYear = function () {
